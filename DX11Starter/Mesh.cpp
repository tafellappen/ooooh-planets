...
Mesh::Mesh(Vertex* vertArray, int vertArrayCt, unsigned int* indexArray, int indexArrayCt, Microsoft::WRL::ComPtr<ID3D11Device> device)
{

	CalculateTangents(&vertArray[0], vertArrayCt, &indexArray[0], indexArrayCt);
	DefineBuffers(vertArray, vertArrayCt, indexArray, indexArrayCt, device);
...
// File input object
	...
	//}
	indexBufferCt = indexCounter;

	CalculateTangents(&verts[0], vertCounter, &indices[0], indexBufferCt);
	DefineBuffers(&verts[0], vertCounter, &indices[0], indexBufferCt, device);
...
{
	return indexBufferCt;
}
void Mesh::DefineBuffers(Vertex* vertArray, int vertArrayCt, unsigned int* indexArray, int indexArrayCt, Microsoft::WRL::ComPtr<ID3D11Device> device)
{
	indexBufferCt = indexArrayCt;

	//vertex buffer description
	D3D11_BUFFER_DESC vbd;
	vbd.Usage = D3D11_USAGE_IMMUTABLE;
	vbd.ByteWidth = sizeof(Vertex) * vertArrayCt;       // 3 = number of vertices in the buffer
	...
	ibd.ByteWidth = sizeof(unsigned int) * indexArrayCt;	// 3 = number of indices in the buffer
...
//
//void Mesh::CreateVertexBufferDesc()
//{
//}
//
//void Mesh::CreateIndexBufferDesc()
//{
//}
